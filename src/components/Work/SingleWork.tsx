    ...
    <div className="w-full">
      ...
      >
        <div className="relative mb-5 flex items-center justify-center z-10">
          <div className="text-[var(--rt-primary)]">{icon}</div>
        </div>
        ...
        <p className="relative z-10 text-base leading-relaxed font-medium text-[var(--rt-ink-dim)] border-t border-[rgba(2,6,23,.08)] pt-6">
          {paragraph}
        </p>
      </div>
    </div>
